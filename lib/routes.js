...
module.exports = function(app) {
  ...
  app.post('/api/session', securityPolicy.enforce('anonUserPageApiNewSession'), session.login);
  ...
  //
  // TODO: add explicit securityPolicy to these oauth2 client routes
  //
  ...
  app.get('/oauth2/authorize', securityPolicy.enforce('knownUserPageApi'), oauth2.authorization);
  app.post('/oauth2/authorize/decision', securityPolicy.enforce('knownUserPageApi'), oauth2.decision);
  app.options('/oauth2/token', securityPolicy.enforce('anonUserApi'));
  app.post('/oauth2/token', securityPolicy.enforce('anonUserApi'), oauth2.token);
  ...
  app.get('/cas/oauth2.0/authorize', securityPolicy.enforce('knownUserPageApi'), oauth2.casAuthorization);
  app.options('/cas/oauth2.0/accessToken', securityPolicy.enforce('anonUserApi'));
  app.get('/cas/oauth2.0/accessToken', securityPolicy.enforce('anonUserApi'), oauth2.formToken);
  ...
  app.get('/cas/validate', securityPolicy.enforce('anonUserApi'), oauth2.casValidate);
  app.get('/cas/serviceValidate', securityPolicy.enforce('anonUserApi'), oauth2.casServiceValidate);
