...
exports.create = function (req, res, next) {
  ...
  // bootstrap the 'admin' user with the 'Admin' group
  if (newUser.username === 'admin') {
    // not needed: user.groups.push('admin');
    newUser.role = 'admin';
  }
  ...
  newUser.save(function(err) {
    if (err) {
      ...
      if(err.errors.username.type === 'Value is not unique.') {
        err.errors.username.type = 'The specified username is already in use.';
      }
