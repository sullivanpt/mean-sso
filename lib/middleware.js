 ...
 *    limit: <limiter name> -- if supplied apply rate limit policy to all authorized requests on this route.
 */
function hasAuthorization(options) {
  ...
  return function(req, res, next) {
    ...
    // difference here is our middleware returns rate limiter by name
    limiter.get(options.limit, req, function (err, limit) {
