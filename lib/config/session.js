...
exports.querySession = function (req, res, next) {
  // primusjs stubs a req object with no cookies, so we need to stub those here
  req.cookies = req.cookies || {};
  req.signedCookies = req.signedCookies || {};
  // req.signedCookies['connect.sid'] = req.query.session_id; // TODO: fix this, this unsigned value
