...
UserSchema
  .pre('validate', function(next) {
    ...
    if (!this.username) {
      // TODO: if this isn't unique because two people signed up simultaneously, they will get
 ...
 * Plugins
 */
UserSchema.plugin(uniqueValidator,  { message: 'The value specified is already in use.' });
